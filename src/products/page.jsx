  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 md:py-8">
      ...
      <div className="bg-white p-4 md:p-6 rounded-xl shadow-md mb-6 md:mb-8">
        ...
        <div className="mb-4 md:mb-6">
          <div className="relative w-full">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-base z-10">
              🔍
            </span>
            <input
              type="text"
              ...
              className="w-full pl-10 pr-12 py-3 border-2 border-gray-300 rounded-lg text-base transition-colors duration-300 focus:outline-none focus:border-blue-500 focus:shadow-[0_0_0_3px_rgba(59,130,246,0.1)] h-12"
            />
            {searchTerm && (
              <button 
                className="absolute right-3 top-1/2 -translate-y-1/2 bg-transparent border-none text-gray-400 text-xl cursor-pointer p-1 rounded-full hover:bg-gray-100 hover:text-gray-600 transition-all duration-200 w-8 h-8 flex items-center justify-center"
        ...
        <div className="mb-4 md:mb-6">
          ...
          <div className="flex flex-wrap gap-2 md:gap-3">
            {categories.map(category => (
              <button
                key={category}
                className={`px-4 md:px-5 py-2 md:py-2.5 border-2 rounded-full text-xs md:text-sm font-medium transition-all duration-300 ${
        ...
        {selectedCategory !== 'all' && getSubCategories().length > 0 && (
          <div className="bg-gray-50 p-4 md:p-5 rounded-lg mb-4 border border-gray-200">
            ...
            <div className="flex flex-wrap gap-2 md:gap-3">
              {getSubCategories().map(subCategory => (
                <label 
                  key={subCategory} 
                  className={`flex items-center cursor-pointer px-3 md:px-4 py-2 bg-white border-2 rounded-md transition-all duration-300 ${
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <label htmlFor="sort-select" className="font-semibold text-gray-900 text-sm md:text-base">
            Sort by:
          </label>
          <select
            id="sort-select"
            ...
            className="w-full sm:w-auto px-4 py-2.5 border-2 border-gray-300 rounded-lg bg-white text-gray-700 text-sm md:text-base transition-colors duration-300 focus:outline-none focus:border-blue-500 min-w-[200px] h-11"
          >
      ...
      {filteredProducts.length === 0 && (
        <div className="text-center py-12 md:py-16 bg-white rounded-xl shadow-md my-8 md:my-12 px-4">
          <div className="text-5xl md:text-6xl mb-5 md:mb-6 opacity-30">🔍</div>
          ...
          <button 
            className="bg-blue-600 text-white border-none px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-sm md:text-base cursor-pointer transition-colors duration-300 hover:bg-blue-700 min-w-[160px] h-11 md:h-12 inline-flex items-center justify-center"
            onClick={() => {
      ...
      {/* Products Info */}
      <div className="text-center py-4 md:py-5 px-4 bg-gray-50 rounded-lg text-gray-600 text-xs md:text-sm mt-4 md:mt-6">
        <p className="mb-1">Showing {filteredProducts.length} of {products.length} products</p>
