...
import { signInAdmin } from "../services/userService";
...
const Header = ({
  ...
  // NEW CODE: Add ref for click-outside detection
  ...
  */
  ...
  /**
   * NEW CODE: Handle click outside to close mobile menu
   */
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (navRef.current && !navRef.current.contains(e.target)) {
        // Check if it's the menu toggle button
    ...
    <header className="header" role="banner">
      <nav className="navbar" aria-label="Main navigation">
        ...
        <div className="header-actions">
          ...
          {user?.role === "admin" && <AdminLink onClose={closeAllPanels} />}
 ...
 */
const NavLinks = React.forwardRef(({ links, isOpen, onLinkClick }, ref) => (
  <div className={`nav-links ${isOpen ? "active" : ""}`} ref={ref}>
    {links.map(({ to, label }) => (
