...
//               console.log(
//                 `Merging size item: ${item.name} size ${item.selectedSize}, Old: ${item.quantity}, Adding: ${actualQuantity}, New: ${item.quantity + actualQuantity}`,
//               );
//               return {
//                 ...item,
...
//           console.log(
//             `New size item: ${product.name} size ${product.selectedSize} with quantity: ${actualQuantity}`,
//           );
//           return [
//             ...prevCart,
//             {
...
//             if (index === existingItemIndex) {
//               console.log(
//                 `Merging regular item: ${item.name}, Old: ${item.quantity}, Adding: ${actualQuantity}, New: ${item.quantity + actualQuantity}`,
//               );
//               return {
//                 ...item,
//                 quantity: item.quantity + actualQuantity,
...
//           // New item
//           console.log(
//             `New regular item: ${product.name} with quantity: ${actualQuantity}`,
//           );
//           return [
//             ...prevCart,
//             {
