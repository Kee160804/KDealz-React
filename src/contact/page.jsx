...
const ContactMethod = ({ title, hours, details, icon, linkText, link, color }) => {
  ...
  return (
    <div className={`flex items-start gap-6 p-6 rounded-2xl transition-all duration-300 relative overflow-hidden ${colorClasses[color] || ''} hover:shadow-xl`}>
      <div className="relative flex-shrink-0">
        ...
        <div className="absolute top-0 left-0 w-[60px] h-[60px] bg-inherit rounded-full animate-pulse-ring opacity-0"></div>
      </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        {link && linkText && (
          <a 
            ...
            className="inline-flex items-center gap-2 mt-4 text-blue-600 font-semibold text-base bg-blue-50 px-4 py-2 rounded-lg hover:gap-3 hover:bg-blue-100 hover:-translate-y-1 transition-all duration-300"
          >
            {linkText}
  ...
  <div className="relative mb-8">
    ...
    <label 
      ...
      className={`absolute left-0 pointer-events-none transition-all duration-300 text-gray-400 text-base origin-left-top
        ${value ? 'transform -translate-y-5 scale-85 text-blue-600' : 'top-5'}`}
    >
      {label}
    </label>
...
const FAQItem = ({ item, isActive, onClick, index }) => {
  ...
  return (
    <div 
      className={`bg-gray-50 rounded-2xl overflow-hidden transition-all duration-300 border-2 ${
        isActive ? 'border-blue-600 bg-white shadow-xl' : 'border-transparent hover:border-blue-600 hover:-translate-y-1 hover:shadow-xl'
      }`}
      style={delayStyle}
    >
      <div className="p-6 cursor-pointer flex gap-6 items-start" onClick={onClick}>
    ...
    <div className="flex justify-center gap-4">
      {[
        ...
        <a 
          key={index}
          href={social.link}
          className="relative w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center text-2xl transition-all duration-300 hover:-translate-y-2 hover:scale-110 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 group"
...
const ContactPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 overflow-x-hidden">
      
      {/* Animated Background Elements */}
      <div className="fixed w-full h-full pointer-events-none z-0">
        <div className="absolute w-[300px] h-[300px] top-[10%] left-[5%] rounded-full bg-gradient-to-br from-purple-200/20 to-pink-200/20 blur-[40px] animate-float-slow"></div>
        <div className="absolute w-[400px] h-[400px] bottom-[10%] right-[10%] rounded-full bg-gradient-to-br from-blue-200/20 to-indigo-200/20 blur-[40px] animate-float-slow animation-delay-5000"></div>
        <div className="absolute w-[200px] h-[200px] top-[50%] left-[80%] rounded-full bg-gradient-to-br from-green-200/20 to-teal-200/20 blur-[40px] animate-float-slow animation-delay-10000"></div>
      </div>
        ...
        <section className="pt-16 pb-8 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4 mt-8">
              ...
              <div className="w-3 h-3 bg-pink-500 rounded-full animate-pulse animation-delay-800"></div>
            </div>
          </div>
        </section>
      ...
      <style jsx>{`
        ...
        .social-icon {
          animation: popIn 0.5s ease-out calc(var(--i) * 0.1s) both;
        }
        .scale-85 {
        ...
        .group-focus-within:focus-within .group-focus-within\\:scale-x-100 {
          transform: scaleX(1);
        }
        .group-focus-within\\:-rotate-135:focus-within {
